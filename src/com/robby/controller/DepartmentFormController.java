...
public class DepartmentFormController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        colStatus.setCellValueFactory(param -> param.getValue().getStatusProperty());
        colStatus.setCellFactory(CheckBoxTableCell.forTableColumn(colStatus));
        colStatus.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<Department, Boolean>>() {
            @Override
            public void handle(TableColumn.CellEditEvent<Department, Boolean> event) {
                System.out.println("Old " + event.getOldValue().booleanValue());
